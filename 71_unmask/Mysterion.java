// Benjamin (Brian Wang, Jun Hong Wang, Nicole Zhou)
// APCS pd6
...
*
* DISCO
* A bunch of inconclusive (?) Data
* Pain
*
* QCC
* Was the main missing an end curly bracket just a typo?
* What exactly is mysterion supposed to return? The value is never used anywhere, and i don't understand what int to return specifically.
* What does Mysterion do?
*
* q0: What does it do?
* a0: I haven't the slightest idea. Results in notes.txt.
*
* q1: O(?)
* a1: Linear, probably?
*
